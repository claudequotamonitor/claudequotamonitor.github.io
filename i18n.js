/* Claude Quota Monitor — i18n for index.html, privacy-policy.html and changelog.html */
...
const CQM_T = {
  ...
  en: {
    ...
    footer_store: 'Chrome Web Store', footer_github: 'GitHub', footer_kofi_link: '♥ Support on Ko-fi', footer_privacy: 'Privacy Policy', footer_changelog: 'Version History', footer_home: 'Home',
    ...
    cl_title_html: 'Version <span>History</span>',
    cl_subtitle: 'All updates, improvements and fixes to Claude Quota Monitor.',
    cl_latest: 'Latest',
    cl_added: '✦ Added',
    cl_improved: '↑ Improved',
    cl_fixed: '✗ Fixed',
    cl_localization: '◎ Localization',
  ...
  pt_BR: {
    ...
    footer_store: 'Chrome Web Store', footer_github: 'GitHub', footer_kofi_link: '♥ Apoiar no Ko-fi', footer_privacy: 'Política de Privacidade', footer_changelog: 'Histórico de Versões', footer_home: 'Início',
    ...
    cl_title_html: 'Histórico de <span>Versões</span>',
    cl_subtitle: 'Todas as novidades, melhorias e correções do Claude Quota Monitor.',
    cl_latest: 'Mais recente',
    cl_added: '✦ Novidades',
    cl_improved: '↑ Melhorias',
    cl_fixed: '✗ Correções',
    cl_localization: '◎ Localização',
  ...
  es: {
    ...
    footer_store: 'Chrome Web Store', footer_github: 'GitHub', footer_kofi_link: '♥ Apoyar en Ko-fi', footer_privacy: 'Política de Privacidad', footer_changelog: 'Historial de Versiones', footer_home: 'Inicio',
    ...
    cl_title_html: 'Historial de <span>Versiones</span>',
    cl_subtitle: 'Todas las novedades, mejoras y correcciones de Claude Quota Monitor.',
    cl_latest: 'Más reciente',
    cl_added: '✦ Novedades',
    cl_improved: '↑ Mejoras',
    cl_fixed: '✗ Correcciones',
    cl_localization: '◎ Localización',
  ...
  fr: {
    ...
    footer_store: 'Chrome Web Store', footer_github: 'GitHub', footer_kofi_link: '♥ Soutenir sur Ko-fi', footer_privacy: 'Politique de Confidentialité', footer_changelog: 'Historique des versions', footer_home: 'Accueil',
    ...
    cl_title_html: 'Historique des <span>Versions</span>',
    cl_subtitle: 'Toutes les nouveautés, améliorations et corrections de Claude Quota Monitor.',
    cl_latest: 'Dernière version',
    cl_added: '✦ Nouveautés',
    cl_improved: '↑ Améliorations',
    cl_fixed: '✗ Corrections',
    cl_localization: '◎ Localisation',
  ...
  ar: {
    ...
    footer_store: 'Chrome Web Store', footer_github: 'GitHub', footer_kofi_link: '♥ الدعم على Ko-fi', footer_privacy: 'سياسة الخصوصية', footer_changelog: 'سجل الإصدارات', footer_home: 'الرئيسية',
    ...
    cl_title_html: 'سجل <span>الإصدارات</span>',
    cl_subtitle: 'جميع التحديثات والتحسينات والإصلاحات في Claude Quota Monitor.',
    cl_latest: 'الأحدث',
    cl_added: '✦ مضاف',
    cl_improved: '↑ تحسينات',
    cl_fixed: '✗ إصلاحات',
    cl_localization: '◎ ترجمة',
  ...
  bn: {
    ...
    footer_store: 'Chrome Web Store', footer_github: 'GitHub', footer_kofi_link: '♥ Ko-fi-তে সমর্থন', footer_privacy: 'গোপনীয়তা নীতি', footer_changelog: 'সংস্করণের ইতিহাস', footer_home: 'হোম',
    ...
    cl_title_html: 'সংস্করণ <span>ইতিহাস</span>',
    cl_subtitle: 'Claude Quota Monitor-এর সমস্ত আপডেট, উন্নতি ও সংশোধন।',
    cl_latest: 'সর্বশেষ',
    cl_added: '✦ নতুন',
    cl_improved: '↑ উন্নতি',
    cl_fixed: '✗ সংশোধন',
    cl_localization: '◎ স্থানীয়করণ',
  ...
  hi: {
    ...
    footer_store: 'Chrome Web Store', footer_github: 'GitHub', footer_kofi_link: '♥ Ko-fi पर सहयोग', footer_privacy: 'गोपनीयता नीति', footer_changelog: 'संस्करण इतिहास', footer_home: 'होम',
    ...
    cl_title_html: 'संस्करण <span>इतिहास</span>',
    cl_subtitle: 'Claude Quota Monitor के सभी अपडेट, सुधार और बग फिक्स।',
    cl_latest: 'नवीनतम',
    cl_added: '✦ नया',
    cl_improved: '↑ सुधार',
    cl_fixed: '✗ बग फिक्स',
    cl_localization: '◎ स्थानीयकरण',
  ...
  id: {
    ...
    footer_store: 'Chrome Web Store', footer_github: 'GitHub', footer_kofi_link: '♥ Dukung di Ko-fi', footer_privacy: 'Kebijakan Privasi', footer_changelog: 'Riwayat Versi', footer_home: 'Beranda',
    ...
    cl_title_html: 'Riwayat <span>Versi</span>',
    cl_subtitle: 'Semua pembaruan, peningkatan, dan perbaikan Claude Quota Monitor.',
    cl_latest: 'Terbaru',
    cl_added: '✦ Ditambahkan',
    cl_improved: '↑ Ditingkatkan',
    cl_fixed: '✗ Diperbaiki',
    cl_localization: '◎ Lokalisasi',
  ...
  ru: {
    ...
    footer_store: 'Chrome Web Store', footer_github: 'GitHub', footer_kofi_link: '♥ Поддержать на Ko-fi', footer_privacy: 'Политика конфиденциальности', footer_changelog: 'История версий', footer_home: 'Главная',
    ...
    cl_title_html: 'История <span>версий</span>',
    cl_subtitle: 'Все обновления, улучшения и исправления Claude Quota Monitor.',
    cl_latest: 'Последняя',
    cl_added: '✦ Добавлено',
    cl_improved: '↑ Улучшено',
    cl_fixed: '✗ Исправлено',
    cl_localization: '◎ Локализация',
  ...
  zh_CN: {
    ...
    footer_store: 'Chrome 网上应用店', footer_github: 'GitHub', footer_kofi_link: '♥ 支持 Ko-fi', footer_privacy: '隐私政策', footer_changelog: '版本历史', footer_home: '首页',
    ...
    cl_title_html: '版本<span>历史</span>',
    cl_subtitle: 'Claude Quota Monitor 的所有更新、改进和修复。',
    cl_latest: '最新版本',
    cl_added: '✦ 新增',
    cl_improved: '↑ 改进',
    cl_fixed: '✗ 修复',
